...
/**
 * 从安卓源代码中copy出来的asynctask代码 修改线程池的RejectedExecutionHandler 异常不崩溃
 * sDefaultExecutor 原来是SERIAL_EXECUTOR 但是发现部分手机是 THREAD_POOL_EXECUTOR 可能被修改过
 * 
 * @author lephone.zh
 * 
 * @param <Params>
...
public abstract class BaseAsyncTask<Params, Progress, Result> {
	 ...
	 *             {@link BaseAsyncTask.Status#RUNNING} or
	 *             {@link BaseAsyncTask.Status#FINISHED}.
	 *
